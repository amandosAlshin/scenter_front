...
const camera_add =(state = initialState, action)=> {
  switch (action.type) {
    case DEFAULT+'CAMERA_ADD':
      return {
        ...state,
        errorserver: {status: false,msg: false},
        loading: false,
    ...
    case SERVER_DISPATCH+'CAMERA_ADD':
      return {
        ...state,
        errorserver: {status: false,msg: false},
        loading: true,
    ...
    case DISPATCH_SUCCESS+'CAMERA_ADD':
      return {
        ...state,
        errorserver: {status: false,msg: false},
        loading: false,
    ...
    case DISPATCH_ERROR+'CAMERA_ADD':
      return {
        ...state,
