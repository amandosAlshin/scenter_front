...
export const waitsBranchGroup = createSelector(
      ...
      for(var i=0; i<=ticket_branch.length-1; i++){
        ...
        if(temp.length > 0){
          arr.push({
            ...
            "waits": _.sumBy(ticket_branch[i].tickets, 'avgWaits'),
      ...
      var output =
          _(arr)
            ...
            .map(function(objs, key, index){
                ...
                'waitsConvert':timeConvert(Math.round(_.sumBy(objs, 'waits')/_.sumBy(objs, 'count') * 100)/100),
