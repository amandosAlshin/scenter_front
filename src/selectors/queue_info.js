...
export const branchGroup = createSelector(
  [ ticketsStatus, tickets,queuesStatus,queues,queuesStatus,queues,filter,filter_filial,filter_branch],
  (ticketsStatus,data,queuesStatus,queues,queuesStatus,queues,filter,filter_filial,filter_branch) => {
