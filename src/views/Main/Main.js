...
class Main extends Component {
  ...
  render() {
    ...
    const state_slaid = this.props.state_slaid.state_slaid;
    return (
      <div>
        <ReactResizeDetector refreshRate={3000} handleWidth handleHeight onResize={this.onResize} />
        <div className="animated fadeIn">
          <CardColumns style={this.props.column_count.column_count > 1 ? {columnCount: 2} : {columnCount: 1}} className="cols-2">
            {
                state_slaid[0] ?
                  <Card>
                    <CardHeader>
